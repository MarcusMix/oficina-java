...
public class ClientesTB extends AbstractTableModel {
	...
	private String[] colunas = new String[] { "Nome", "CPF", "E-mail","Telefone-1", "Cidade", "Estado", "Edit" };
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case ESTADO:
			...
			break;
		case EDIT:
			clientes.setEdit((String) aValue);
			break;
		default:
			throw new IndexOutOfBoundsException("columnIndex out of bounds");
		}
	...
	public void removeClient(int indiceLinha) {
		// Remove o registro.
	...
	public void addListaClients(List<ClientModel> clientes) {
