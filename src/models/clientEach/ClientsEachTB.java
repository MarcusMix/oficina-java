package models.clientEach;

import java.util.List;
import java.util.ArrayList;
import javax.swing.table.AbstractTableModel;

public class ClientsEachTB extends AbstractTableModel {
	
	private String[] colunas = new String[] { "Nome", "RG","CPF", "E-mail", "Cidade", "Nascimento" };
	...
	private static final int NASCIMENTO = 5;
	
	
	//clientes model
	private List<ClientEachModel> linhas;
	
	public ClientsEachTB(List<ClientEachModel> listaClientes) {
		linhas = new ArrayList<ClientEachModel>(listaClientes);
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		ClientEachModel clientes = linhas.get(rowIndex);
		...
		public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		    ...
		    case NASCIMENTO:
		    	clientes.setNascimento((String) aValue);
		    default:
		        throw new IndexOutOfBoundsException("columnIndex out of bounds");
		    }
	 ...
	 // Remove o local  da linha especificada.
	 		...
	 		public void addListaLocais(List<ClientEachModel> clientes) {
